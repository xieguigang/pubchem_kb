...
Public Module PDFText
    ...
    Private Function BuildMetadataPrompt(rawText As String) As String
        ...
        sb.AppendLine("{""title"": ""<article title>"", ""doi"": ""<doi id>"", ""year"": ""<XXXX>"", ""journal"": ""<journal name>"", ""keywords"": [""<keyword1>"", ""<keyword2>""]}")
        sb.AppendLine()
        Return sb.ToString()
    End Function
    ...
    Private Function BuildReferencesPrompt(rawText As String) As String
        ...
        sb.AppendLine("[{""title"": ""<article title>"", ""doi"": ""<doi id>"", ""year"":""<XXXX>"", ""journal"":""<journal name>""}, ...]")
        sb.AppendLine()
    ...
    Private Function BuildFullTextPrompt(rawText As String) As String
        ...
        sb.AppendLine("3. 使用 Markdown 标题层级组织文档结构（# 一级标题、## 二级标题、### 三级标题等），标题与段落文本间需要有一行空白行")
