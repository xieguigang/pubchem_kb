#Region "Microsoft.VisualBasic::2f88aef9468756a72c9dc77403784ffa, ..\sciBASIC#\Data_science\Mathematical\ODEsViewer\FormLoadModel.vb"
...
Public Class FormLoadModel
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For Each m As Type In models
            If InputHandler.ToString(ListBox1.SelectedItem) = m.FullName Then
                _Model = m
                Exit For
            End If
        Next
